...
# Call range cells from MS Excel
...
# Call poes cell
DET_POES = "poes"
STOC_STOIIP_RESULTS = "poes_prob"
STOC_STOIIP_ARR = "poes_array"
...
def main():
    ...
    input_col_names = df_poes[INPUT_VAR_NAMES].to_list()
    ...
    for col, idx in input_dict.items():
        results_dict[col] = param_poes(
            df_poes, idx, DIST, LOC, SCALE, iterations, SC, LIM_MIN, LIM_MAX, seed
        )

    # Calculation of stoiip's mean, std, P10, P50, and P90
    results_dict[STOC_STOIIP_RESULTS] = poes(
    ...
    sheet_1 = wb.sheets[SHEET_RESULTS]
